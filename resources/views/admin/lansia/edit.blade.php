		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<form class="form-horizontal" method="post" action="{{ route('lansia.update', $datas->id_lansias) }}">
						@csrf
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										...
										<input type="text" class="form-control" placeholder="Nama Lansia" name="nama_lansias" value="{{ $datas->nama_lansias }}" required>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										...
										<input type="text" class="form-control" placeholder="Nama Wali" name="nama_wali" value="{{ $datas->nama_wali }}" required>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group" style="padding-right: 6px;">
										...
										<input type="text" class="form-control" placeholder="Tempat Lahir" name="tpt_lahir" value="{{ $datas->tpt_lahir }}" required>
									</div>
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="form-check-inline">
										...
										<input type="radio" name="jenis_kelamin" class="form-check-input minimal" value="{{ $datas->jenis_kelamin }}" required> Laki-Laki </label>
										<label class="form-check-label">
										<input type="radio" name="jenis_kelamin" class="form-check-input minimal" value="{{ $datas->jenis_kelamin }}" required> Perempuan </label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-id-card"></i></span>
										<input type="number" class="form-control" placeholder="Nomor BPJS (bila ada)" name="No_BPJS" value="{{ $datas->No_BPJS }}" required>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										...
										<input type="text" class="form-control" placeholder="Periksa Kesehatan" name="periksa_kesehatan" value="{{ $datas->periksa_kesehatan }}" required>
									</div>
								</div>
							</div>
						</div>
