...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs pull-right">
        ...
        <h4 class="pull-left header"><a href="{{ route('ibuhamil.create') }}" class="btn btn-primary"><span><i class="fa fa-plus-square" aria-hidden="true"></i></span> Tambah Data</a>| Data Ibu</h4>
    </ul>
                            ...
                            <table id="example1" class="table table-bordered table-striped" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 17%; text-align: center;">Nama Bumil</th>
                                        <th style="width: 16%; text-align: center;">Nama Suami</th>
                                ...
                                <tfoot>
                                    <tr>
                                        <th style="width: 10%; text-align: center;">#</th>
                                        <th style="width: 16%; text-align: center;">Nama Bumil</th>
                                        <th style="width: 17%; text-align: center;">Nama Suami</th>
                                        <th style="width: 8%; text-align: center;">Usia</th>
                                        <th style="width: 20%; text-align: center;">Alamat</th>
                                        <th style="width: 10%; text-align: center;">Usia Kehamilan</th>
                                        <th style="width: 7%; text-align: center;">LiLa</th>
