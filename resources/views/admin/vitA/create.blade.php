...
<div class="panel panel-default">
	<div class="panel-heading">Tambah Data Vitamin A</div>
	<div class="panel-body">
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					<form class="form-horizontal" method="post" action="{{ route('vitA.store') }}">
						@csrf
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group date">
										...
										<input type="text" class="form-control pull-right" id="datepicker" placeholder="Tanggal Vitamin A" name="tgl_vitA" value="{{ $data->tgl_vitA }}" required autocomplete="off">
									</div>
								</div>
							</div>
						</div>
