...
<!--                <h3 class="box-title">Data Pemberian Vitamin A</h3><br> -->
                    <h3 class="box-title" style="margin-right: 40px"><a href="{{ route('vitA.create') }}" class="btn btn-sm btn-primary"><span><i class="fa fa-plus-square" aria-hidden="true"></i></span> Tambah Data</a> | Pemberian Vitamin A</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
