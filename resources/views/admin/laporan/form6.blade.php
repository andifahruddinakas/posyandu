        ...
        <tr>
            ...
            <td>
                <p style="font-size: 15px; margin-top: 0px; margin-bottom: 0px">
                    <strong>PEMERINTAH KABUPATEN ACEH UTARA</strong>
                </p>
                <p style="font-size: 15px; margin-top: 0px; margin-bottom: 0px">
                    <strong>GAMPONG TEUPIN BEULANGAN</strong>
                </p>
                <p style="font-size: 12px; margin-bottom: 0px; margin-top: 0px">
                    <strong>KECAMATAN SAMUDERA</strong>
                </p>
                <p style="font-size: 12px; margin-bottom: 0px; margin-top: 0px">
                    <strong>Jl. Teupin Beulangan Dusun Teungku Dikrueng No.1</strong>
                </p>
                <p style="font-size: 12px; margin-bottom: 0px; margin-top: 0px">
                    <strong>Telp. 081269701118</strong>
                </p>
            </td>
    ...
    <table width="100%" style="text-align: center; margin: 0px; font-size: 11px;">
        <tr>
            <td>
                ...
                <p style="font-size: 12px; margin: 0px">
                    <strong>PKM TEUPIN BEULANGAN KEC. SAMUDERA</strong>
                </p>
                <p style="font-size: 12px; margin: 0px">
    ...
    <table width="100%" style="text-align: center; margin: 0px">
        <tr>
            ...
            <td>
                ...
                <p style="font-size: 12px; margin-bottom: 0px; margin-top: 0px">
                    <strong>UPTD PUSKESMAS SAMUDERA</strong>
                </p>
                <p style="font-size: 12px; margin-bottom: 0px; margin-top: 0px">
                    <strong>Jl. Teupin Beulangan Dusun Teungku Dikrueng No.1 Kecamatan Samudera</strong>
                </p>
                <p style="font-size: 12px; margin-bottom: 0px; margin-top: 0px">
    ...
    <table width="100%" style="text-align: center; margin: 0px; font-size: 11px;">
        <tr>
            <td>
                ...
                <p style="font-size: 12px; margin: 0px">
                    <strong>PKM SAMUDERA KEC. SAMUDERA</strong>
                </p>
                <p style="font-size: 12px; margin: 0px">
                    <strong>VITAMIN A</strong>
                </p>
