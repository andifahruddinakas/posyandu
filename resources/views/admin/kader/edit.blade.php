		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<form class="form-horizontal" method="post" action="{{ route('kader.update', $datas->id) }}">
						@csrf
							...
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										...
										<input type="text" class="form-control" placeholder="Nama Kader" name="nama_ibu" value="{{ $datas->nama_ibu }}" required>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="input-group col-md-8">
									<div class="form-check-inline">
										<label class="form-check-label" style="padding: 6px 10px 0px 0px;">
											<input type="radio" name="gakin" class="form-check-input minimal" value="Non Gakin" <?php echo ($datas->gakin == 'Non Gakin')?'checked':'' ?> > Non Gakin
										</label>
										<label class="form-check-label">
											<input type="radio" name="gakin" class="form-check-input minimal" value="Gakin" <?php echo ($datas->gakin == 'Gakin')?'checked':'' ?> > Gakin
										</label>
									</div>
								</div>
							</div>
								...
								<div class="input-group col-md-8">
									<div class="input-group">
										...
										<select class="form-control" name="jabatan" style="width: 100%;" required>
											<option selected="selected" value="{{ $datas->jabatan }}">
												@if ($datas->jabatan == 1)
		                                            Ketua
