                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 12%;text-align: center;">Nik Kader</th>                            
                            <th style="width: 15%;text-align: center;">Nama Kader</th>
                            <th style="width: 21%;text-align: center;">Tempat/Tgl Lahir</th>
                            <th style="width: 15%;text-align: center;">Alamat</th>
                            <th style="width: 9%;text-align: center;">Jabatan</th>
                            <th style="width: 10%;text-align: center;">No. Telp</th>
