    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title" style="margin-right: 40px"><a href="{{ route('ibu.create') }}" class="btn btn-sm btn-primary"><span><i class="fa fa-plus-square" aria-hidden="true"></i></span> Tambah Data</a> | Data Ibu Balita</h3>
                ...
                <table id="example1" class="table table-bordered table-striped" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 18%;text-align: center;">Nama Ibu</th>
                            <th style="width: 18%;text-align: center;">Nama Suami</th>
                            <th style="width: 17%;text-align: center;">Alamat</th>
                            <th style="width: 12%;text-align: center;">No. BPJS</th>
