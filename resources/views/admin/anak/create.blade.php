						...
						<div class="form-group form-inline">
							<div class="row">
								...
								<div class="input-group col-md-8">
									...
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-id-card fa-fw"></i></span>
										<input type="number" class="form-control" placeholder="No. KIA" name="no_kia">
									</div>
								</div>
							</div>
						</div>
						<div class="form-group form-inline">
							<div class="row">
								...
								<div class="input-group col-md-8">
									<div class="input-group" style="padding-right: 6px;">
										<span class="input-group-addon"><i class="fa fa-id-card fa-fw"></i></span>
										<input type="number" class="form-control" placeholder="Nomor BPJS" name="BPJS_anak">
									</div>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-id-card fa-fw"></i></span>
										<input type="number" class="form-control" placeholder="Tag Idcard" name="id_card">
									</div>
								</div>
							</div>
						</div>
