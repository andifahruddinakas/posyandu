    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="{{ route('admin') }}" class="logo" style="background-color: #2c3e50">
                ...
                <span class="logo-lg"><b>POSYANDU</b></span>
            </a>
            ...
            <section class="sidebar">
                ...
                @if (Auth::user()->level == 1)
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="header">BERANDA UTAMA</li>
                        <li>
                            <a href="{{ route('admin') }}">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-database"></i> <span>Data Induk</span>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{ route('lansia.index') }}"><i class="fa fa-circle-o"></i> Data Lansia</a></li>
        ...
        <footer class="main-footer">
            <strong>Informasi Posyandu </strong>Teupin Beulangan
        </footer>
    </div>
